...
export function useGeneralStore(): GeneralStore {
  ...
  state.Signal = new Signal({ state, setter, globalStates });
  state.Candle = new Candle({ state, setter, globalStates });
  state.Session = new Session({ state, setter, globalStates });
  state.WorkTime = new WorkTime({ state, setter, globalStates });
  state.MicroTime = new MicroTime({ state, setter, globalStates });
  state.Liquidity = new Liquidity({ state, setter, globalStates });
  state.COB = new CandleOrderBlock({ state, setter, globalStates });
  state.MSS = new MarketShiftStructure({ state, setter, globalStates });
