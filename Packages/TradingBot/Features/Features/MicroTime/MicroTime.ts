import {IMicroTime, ISession, IWorkTime,} from "@shared/Types/Interfaces/general.ts";
...
export default class MicroTime {
    ...
    isExists(start: number, end: number, type: MicroTimeType): IMicroTime | undefined {
        return this.microTimes.getAll().find((m) => m.start.unix === start && m.end.unix === end && m.type === type);
    }
